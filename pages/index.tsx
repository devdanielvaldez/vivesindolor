...
const Home: NextPage = (): JSX.Element => {
  return (
    <>
      <SEO
        description={
          "Empresa dedicada a la prevención, atención y recuperación de todo tipo de enfermedades que afectan. Contamos con especialistas altamente capacitados. Separa citas, recibe tratamiento y vive sin dolor"
        }
        image={`${WEB_LINK}/img/osteocenter-logo.png`}
        title="Vive Sin Dolor - Reserva tu cita en
          linea"
        keywords={
